...
Curso en video
  ...
  -> chunking con FFmpeg si el audio supera límite de tamaño o duración
...
5. Chunking: si el MP3 supera el límite de tamaño o duración, se mide con FFprobe y se divide con FFmpeg en `output/chunks/{course-name}/{video-name}/chunk_001.mp3`.
